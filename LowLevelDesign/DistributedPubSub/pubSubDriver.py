...
def driver():
    ...
    q.addSubscriber("topicId-1", Subscriber("sub-1", "sub-one"))
    q.addSubscriber("topicId-1", Subscriber("sub-2", "sub-two"))
    q.addSubscriber("topicId-1", Subscriber("sub-3", "sub-three"))
